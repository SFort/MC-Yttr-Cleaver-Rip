package tf.ssf.sfort.yttr.content.block.decor;
...
import tf.ssf.sfort.yttr.mixinsupport.YttrWorld;
import tf.ssf.sfort.yttr.util.math.opengjk.OpenGJK;
...
public class CleavedBlockEntity extends BlockEntity implements RenderAttachmentBlockEntity {
	...
	public class CleavedMeshTarget {
		...
		public volatile CleavedBlockMeshes.UniqueShapeKey key;
	...
	public @Nullable Object getRenderAttachmentData() {
		target.key = new CleavedBlockMeshes.UniqueShapeKey(donor, polygons);
		return target;
	}
